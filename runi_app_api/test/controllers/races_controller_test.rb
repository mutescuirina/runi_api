...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { distance: @race.distance, location: @race.location, month: @race.month, name: @race.name } }, as: :json
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { distance: @race.distance, location: @race.location, month: @race.month, name: @race.name } }, as: :json
    assert_response 200
  end
